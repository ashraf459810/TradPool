    ...
    return DropdownButton<dynamic>(
      ...
      items: widget.list.map((dynamic value) {
        return DropdownMenuItem<dynamic>(
            ...
            child: value is String
                ...
                : Center(
                    child: Text(
                AppLocalizations.of(context).locale.languageCode=="ar"? value.arabicName:   value.name,
      ...
      onChanged: (value) {
        setState(() {
          ...
          value is String ? chosenvalue = value :     AppLocalizations.of(context).locale.languageCode=="ar"?chosenvalue=  value.arabicName:  chosenvalue = AppLocalizations.of(context).translate( value.name);
          int index = 0;
